...
public class jugar extends javax.swing.JFrame {
    ...
    public jugar() {
        ...
        fondo = new VenFondo(getWidth(), getHeight());
    ...
    private void reiniciar() {
        ...
        caraUp = false;
        puntaje = 0;
        System.out.println("Se sobreescribirá los datos guardados anteriormente");
    }
    ...
    private void pregwin() {
        if(!btnC1.isEnabled() && !btnC2.isEnabled() && !btnC3.isEnabled() && !btnC4.isEnabled() && !btnC5.isEnabled() && !btnC6.isEnabled() && 
            ...
            JOptionPane.showMessageDialog(this, "Felicidades, has ganado. Su puntuación es: "+puntaje, "Win!!", JOptionPane.INFORMATION_MESSAGE);
     }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Encuentra su pareja:");
        ...
        Boton2.setForeground(new java.awt.Color(0, 204, 0));
    ...
    private void Boton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Boton2ActionPerformed
        int x = this.puntaje;
        try {
            FileWriter fichero = new FileWriter("C:\\Users\\carli\\OneDrive\\Escritorio\\Prueba2\\JuegoParejas\\JuegoParejas\\JuegoParejas\\puntuaciones");
        
            fichero.write("Resultado = "+ x +"\n" );
